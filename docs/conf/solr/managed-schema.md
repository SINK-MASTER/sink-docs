...
<schema name="default-config" version="1.6">
  ...
  <field name="addTime" type="string" uninvertible="true" indexed="true" stored="true"/>
  <field name="content" type="text_ik" uninvertible="true" indexed="true" stored="true"/>
  <field name="contentId" type="string" uninvertible="true" indexed="true" stored="true"/>
  <field name="headImg" type="string" uninvertible="true" indexed="true" stored="true"/>
  <field name="id" type="string" multiValued="false" indexed="true" required="true" stored="true"/>
  <field name="integral" type="pint" uninvertible="true" indexed="true" stored="true"/>
  <field name="keyWord" type="text_ik" uninvertible="true" indexed="true" stored="true"/>
  <field name="levelIcon" type="string" uninvertible="true" indexed="true" stored="true"/>
  <field name="levelName" type="string" uninvertible="true" indexed="true" stored="true"/>
  <field name="levelNum" type="pint" uninvertible="true" indexed="true" stored="true"/>
  <field name="nickName" type="string" uninvertible="true" indexed="true" stored="true"/>
  <field name="starNum" type="pint" uninvertible="true" indexed="true" stored="true"/>
